...
$mod_strings = array(
    ...
    'LBL_ERROR' => 'Error',
    'LBL_USER_UPDATED_LEAD' => 'Updated Person',
    'LBL_DATE_UPDATE_LEAD' => 'Updated Date',
    'LBL_LINK_FILE' => 'Link File',
    'LBL_NUMBER_IMPORT_LEAD' => 'Number Import In Day',
    ...
    'LBL_MODULE_SUCCESSFUL' => 'Import successful ',
    'LBL_ROW' => ' row! ',
    ...
    'LBL_LEADS_TITLE' => 'UPLOAD LIST LEADS FROM IMPORT FILE',
    "LBL_INTRODUCTION_LEADS_1" => "*Note: After downloading the sample file to",
    "LBL_INTRODUCTION_LEADS_2" => "\"Absolutely do not change the position of columns and rows in the sample file!\"",
    "LBL_INTRODUCTION_LEADS_3" => "*Note:",
    "LBL_INTRODUCTION_LEADS_4" => "\"There are 2 ways to add Lead, 1. No need group, 2.Choose a campaign\"",
    "LBL_CHOOSE_GROUP_SECURITY" => "-- Choose Group --",
    "LBL_CHOOSE_COMPAIGNS" => "-- Choose Campaign --",
    "LBL_CHOOSE_IMPORT_NUMBER" => "-- Choose import number --",
    ...
    'LBL_CANNOT_FIND_USER_ASSIGN' => 'Cannot import record because not find field Assigned User at record ',
    'LBL_CANNOT_FIND_CAMPAIGN' => 'Cannot import record because not find field Campaign Id at record ',
