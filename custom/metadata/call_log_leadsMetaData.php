...
$dictionary['call_log_leads'] = array(
    'table' => 'call_log_leads', 'fields' => array(
        ...
        array('name' => 'user_call', 'type' => 'varchar', 'len' => '255'),
        array('name' => 'lead_name', 'type' => 'varchar', 'len' => '255'),
        array('name' => 'call_date', 'type' => 'varchar', 'len' => '255'),
        array('name' => 'call_status', 'type' => 'varchar', 'len' => '255'),
        array('name' => 'description_call_status', 'type' => 'varchar', 'len' => '255'),
    ), 'indices' => array(
